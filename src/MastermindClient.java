...
public class MastermindClient {
    ...
    public void connect(String host, int port, Consumer<String> messageCallback) throws IOException {
        ...
        // TODO: Setup I/O streams
        
        // TODO: Store callback and set flags
        
        // TODO: Create and start listener thread
    ...
    public void send(String message) {
        if(out != null && connected == true && message != null) {
            out.println(message);
        }
    }
    ...
    public boolean isConnected() {
        if(!connected || socket == null || socket.isClosed() == true) {
            return false;
        }
        return true;
    }
